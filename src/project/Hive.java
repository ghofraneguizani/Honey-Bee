...
public class Hive {
	...
	private int foragersAtAll; // une variable pour voir à la fin du jeu combien d'abeilles étaient dans le jeu
								// au total
	...
	public int getRandomLiveTime() { // un nombre aléatoire, de sorte qu'au début toutes les abeilles n'ont pas le
										// même âge
