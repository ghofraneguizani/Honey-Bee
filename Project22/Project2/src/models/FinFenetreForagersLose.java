...
public class FinFenetreForagersLose extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FinFenetreForagersLose(int numbForagers, long numbPollen, int rounds) {
		setVisible(true);
		setResizable(false);
		...
		ImageIcon icon = new ImageIcon("img/brown-rectangle-button-panel-hi.png") ;  
		...
		lblNewLabel_3.setBounds(555, 251, 500, 29);
		...
		lblMort.setBounds(555, 338, 500, 29);
		panel.add(lblMort);
		...
		roundsInGame.setBounds(555, 425, 500, 29);
